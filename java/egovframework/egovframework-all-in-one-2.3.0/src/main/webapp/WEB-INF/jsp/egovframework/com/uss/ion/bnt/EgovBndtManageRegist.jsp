...
<caption>당직 등록</caption>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="bndtId">당직자명</label><img src="/images/egovframework/com/uss/ion/bnt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%" >
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="orgnztNm">소속</label><img src="/images/egovframework/com/uss/ion/bnt/icon/no_required.gif" width="15" height="15" alt=""></th>
    <td width="80%">
        <input name="orgnztNm" id="orgnztNm" type="text" title="소속" class="readOnlyClass" readonly>
    </td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="bndtDe">당직일자</label><img src="/images/egovframework/com/uss/ion/bnt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%">
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="remark">비고</label><img src="/images/egovframework/com/uss/ion/bnt/icon/required.gif" width="15" height="15" alt=""></th>
    <td width="30%" class="title_left">
