...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="/images/egovframework/com/uss/ion/vct/icon/tit_icon.gif" width="9" height="9" hspace="3" alt="">&nbsp;휴가 신청자</td>
 </tr>
</table>
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register"  summary="신청자 정보" >
	<caption>신청자 정보</caption>
  <tr>
    <th width="20%" height="23" class="required_text">신청자<img src="/images/egovframework/com/uss/ion/vct/icon/no_required.gif" width="15" height="15" alt=""></th>          
    <td width="30%"><c:out value='${vcatnManageVO.applcntNm}'/></td>
    <th width="20%" height="23" class="required_text">소속<img src="/images/egovframework/com/uss/ion/vct/icon/no_required.gif" width="15" height="15" alt=""></th>          
...
<caption>휴가승인/반려</caption>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">휴가구분<img src="/images/egovframework/com/uss/ion/vct/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3"><c:out value='${vcatnManageVO.vcatnSeNm}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">시작일자<img src="/images/egovframework/com/uss/ion/vct/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"><c:out value='${vcatnManageVO.bgnde}'/></td>
    <c:if test="${vcatnManageVO.vcatnSe ne '02' }">
    <th width="20%" height="23" class="required_text" scope="row">종료일자<img src="/images/egovframework/com/uss/ion/vct/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"  ><c:out value='${vcatnManageVO.endde}'/></td>
    </c:if>
    <c:if test="${vcatnManageVO.vcatnSe eq '02' }">
    <th width="20%" height="23" class="required_text" scope="row" >정오구분<img src="/images/egovframework/com/uss/ion/vct/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">휴가사유<img src="/images/egovframework/com/uss/ion/vct/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3">
