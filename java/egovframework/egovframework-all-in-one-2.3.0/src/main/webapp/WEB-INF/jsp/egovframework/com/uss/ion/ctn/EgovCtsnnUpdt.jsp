...
<caption>소속정보</caption>
 <tr>
  <td width="100%" class="title_left">
   <img src="/images/egovframework/com/uss/ion/ctn/icon/tit_icon.gif" width="9" height="9" hspace="3" align="absmiddle" alt="">&nbsp;경조 신청자</td>
 </tr>
</table>
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="소속정보" >
<caption>소속정보</caption>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">신청자<img src="/images/egovframework/com/uss/ion/ctn/icon/no_required.gif" width="15" height="15" alt=""></th>          
...
<caption>경조수정</caption>
  ...
  <tr>
    ...
    <th width="20%" height="23" class="required_text"  scope="row"><label for="trgterNm">발생일</label><img src="/images/egovframework/com/uss/ion/ctn/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%">
