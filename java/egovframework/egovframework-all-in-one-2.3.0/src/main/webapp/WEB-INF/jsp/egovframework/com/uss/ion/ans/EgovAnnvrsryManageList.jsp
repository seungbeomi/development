...
* ******************************************************** */
function fn_egov_schdulCharger_LeaderSchdule_Annvrsry(number){
	var arrParam = new Array(6);
	arrParam[0] = window;
	arrParam[1] = '당직 대상자';
	arrParam[2] = 'annvrsryId'+number;
	arrParam[3] = '';
	arrParam[4] = 'annvrsryTemp1'+number;
	arrParam[5] = 'annvrsryTemp2'+number;
...
<caption>기념일관리목록 검색조건</caption>
  <tr> 
    <th width="20%" height="23" scope="row" class="required_text"><label for="searchKeyword">년도</label><img src="/images/egovframework/com/uss/ion/ans/icon/no_required.gif" width="15" height="15" alt=""></th>
    <td width="80%">
