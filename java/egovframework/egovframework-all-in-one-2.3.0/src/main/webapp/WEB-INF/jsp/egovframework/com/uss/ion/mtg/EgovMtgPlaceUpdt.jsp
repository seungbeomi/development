...
<caption>회의실 수정</caption>
  <tr> 
    <th height="23" class="required_text" scope="row"><label for="mtgPlaceNm">회의실 명<img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td colspan ="3">
       <form:input  path="mtgPlaceNm" title="회의실명" size="80"  />
    </td>
  </tr> 
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="aceptncPosblNmpr">수용가능인원</label><img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td width="20%" nowrap>
    ...
    <th width="20%" height="23" class="required_text" scope="row"><label for="opnBeginTm">개방시간</label><img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td >
...
~        <select name="opnEndTm" title="개방종료시간">
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="lcSe">위치</label><img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td colspan ="3" >
...
<!--  첨부파일 테이블 레이아웃 설정 Start.. -->
	<c:if test="${mtgPlaceManage.atchFileId ne null && mtgPlaceManage.atchFileId ne ''}">
	<tr> 
		<th height="23" class="required_text" scope="row"><label for="atchFileId">이미지 파일목록</label><img src="/images/egovframework/com/uss/ion/mtg/icon/no_required.gif" width="15" height="15" alt=""></th>
		    <td colspan="3">
  ...
  <tr>
	<th width="20%" height="23" class="required_text"  scope="row"><label for="file_1">이미지 파일첨부</label><img src="/images/egovframework/com/uss/ion/mtg/icon/no_required.gif" width="15" height="15" alt=""></th>
	<td colspan="3">
...
<caption>회의실  비품정보 수정</caption>
  <tr> 
    <th width="20%" height="150" class="required_text" scope="row"><label for="fxtrsForm">비품정보</label><img src="/images/egovframework/com/uss/ion/mtg/icon/no_required.gif" width="15" height="15" alt=""></th>
