...
<caption>포상자정보</caption>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">포상자<img src="/images/egovframework/com/uss/ion/rwd/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
...
<!-- 첨부파일 테이블 레이아웃 End.-->
  ...
  <tr>
	<th width="20%" height="23" class="required_text" scope="row"><label for="file_1">파일첨부</label><img src="/images/egovframework/com/uss/ion/rwd/icon/no_required.gif" width="15" height="15" alt=""></th>
	<td colspan="3">
