...
<td height="60">
    ...
    <td>
		...
		<td>
			...
			<img src="<c:url value='/images/egovframework/com/cop/smt/lsm/icon/icoPrev.gif' />" style="margin-right:4px;border:0px;" alt="이전년도">
			</a>
			<font size='3'><b><%=iNowYear%>년</b></font>
			<a href="<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulDailyList.do' />?year=<%=iNowYear+1%>&amp;month=<%=iNowMonth%>&amp;day=<%=iNowDay%>" target="_self">
			<img src="<c:url value='/images/egovframework/com/cop/smt/lsm/icon/icoNxt.gif' />" style="margin-left:4px;border:0px;" alt="다음년도">
			</a>
			</td>
			...
			<img src="<c:url value='/images/egovframework/com/cop/smt/lsm/icon/icoPrev.gif' />" style="margin-right:4px;border:0px;" alt="이전월">
			</a>
			<%}%>
			<font size='3'><b><%=iNowMonth+1%>월</b></font>
			<%if(iNowMonth < 11 ){ %>
			<a href="<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulDailyList.do' />?year=<%=iNowYear%>&amp;month=<%=iNowMonth+1%>&amp;day=<%=iNowDay%>" target="_self">
			<img src="<c:url value='/images/egovframework/com/cop/smt/lsm/icon/icoNxt.gif' />" style="margin-left:4px;border:0px;" alt="다음월">
			</a> 
			<%}%>
			</td>
			...
			<img src="<c:url value='/images/egovframework/com/cop/smt/lsm/icon/icoPrev.gif' />" style="margin-right:4px;border:0px;" alt="이전일">
			</a>
			<%}%>
			<font size='3'><b><%=iNowDay%>일</b></font>
			<%if(iNowDay < iEndDay ){ %>
			<a href="<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulDailyList.do' />?year=<%=iNowYear%>&amp;month=<%=iNowMonth%>&amp;day=<%=iNowDay+1%>" target="_self">
			<img src="<c:url value='/images/egovframework/com/cop/smt/lsm/icon/icoNxt.gif' />" style="margin-left:4px;border:0px;" alt="다음일">
			</a> 
			<%}%>
			</td>			
			</tr>
