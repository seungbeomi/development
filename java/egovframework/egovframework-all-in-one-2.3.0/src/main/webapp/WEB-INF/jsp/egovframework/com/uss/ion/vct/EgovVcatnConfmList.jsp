...
<!-- ********** 여기서 부터 본문 내용 *************** -->
	...
	<table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	   <h1><img src="/images/egovframework/com/uss/ion/vct/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;휴가승인관리 목록</h1></td>
	  <th>
	  </th>
  <td width="50%">&nbsp;</td>
  <th width="10%" align="right">
	...
	<caption>휴가승인관리 검색조건</caption>
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchConfmAt">진행구분</label><img src="/images/egovframework/com/uss/ion/vct/icon/no_required.gif" width="15" height="15" alt=""></th>          
	    <td width="30%" >
	    ...
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchYear">휴가일자</label><img src="/images/egovframework/com/uss/ion/vct/icon/no_required.gif" width="15" height="15" alt=""></th>          
	    <td width="30%">
	  ...
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchNm">신청자</label><img src="/images/egovframework/com/uss/ion/vct/icon/no_required.gif" width="15" height="15" alt=""></th>          
