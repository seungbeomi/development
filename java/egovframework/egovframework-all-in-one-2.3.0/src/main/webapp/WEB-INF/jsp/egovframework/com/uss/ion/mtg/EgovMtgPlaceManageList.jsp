...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="회의실관리 검색조건" >
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="searchKeyword">회의실명</label><img src="/images/egovframework/com/uss/ion/mtg/icon/no_required.gif" width="15" height="15" alt=""></th>
    <td width="80%" >
