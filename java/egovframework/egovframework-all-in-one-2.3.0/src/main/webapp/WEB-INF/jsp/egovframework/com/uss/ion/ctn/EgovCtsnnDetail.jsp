...
<caption>소속정보</caption>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row" >경조자<img src="/images/egovframework/com/uss/ion/ctn/icon/no_required.gif" width="15" height="15" alt=""></th>          
    <td width="30%"><c:out value='${ctsnnManageVO.usNm}'/></td>
    <th width="20%" height="23" class="required_text"  scope="row" >소속<img src="/images/egovframework/com/uss/ion/ctn/icon/no_required.gif" width="15" height="15" alt=""></th>          
...
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register"  summary="경조  상세" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">경조명<img src="/images/egovframework/com/uss/ion/ctn/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3"><c:out value='${ctsnnManageVO.ctsnnNm}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text"   scope="row">경조구분<img src="/images/egovframework/com/uss/ion/ctn/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"><c:out value='${ctsnnManageVO.ctsnnCdNm}'/></td>
    <th width="20%" height="23" class="required_text"   scope="row">발생일<img src="/images/egovframework/com/uss/ion/ctn/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"><c:out value='${ctsnnManageVO.occrrDe}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">대상자명<img src="/images/egovframework/com/uss/ion/ctn/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3"><c:out value='${ctsnnManageVO.trgterNm}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">관계<img src="/images/egovframework/com/uss/ion/ctn/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"><c:out value='${ctsnnManageVO.relateNm}'/></td>
    <th width="20%" height="23" class="required_text" scope="row">생년월일<img src="/images/egovframework/com/uss/ion/ctn/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"><c:out value='${ctsnnManageVO.brth}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">비고<img src="/images/egovframework/com/uss/ion/ctn/icon/no_required.gif" width="15" height="15" alt=""></th>          
    <td colspan="3">
