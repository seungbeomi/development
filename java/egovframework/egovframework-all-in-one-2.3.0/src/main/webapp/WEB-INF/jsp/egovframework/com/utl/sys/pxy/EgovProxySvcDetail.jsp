...
<table border="0">
  <tr>
    ...
    <table width="100%" cellpadding="1" class="table-register" summary="프록시설정에 대한 상세정보를 제공한다.">
      ...
      <tr>
        <th class="required_text" width="20%" scope="row">프록시ID<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt="" /></th>
        <td class="lt_text"><c:out value='${proxySvc.proxyId}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row">프록시명<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt="" /></th>
        <td class="lt_text"><c:out value='${proxySvc.proxyNm}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row">프록시IP<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt="" /></th>
        <td class="lt_text"><c:out value='${proxySvc.proxyIp}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row">프록시Port<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt="" /></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row">서비스설명<img src="/images/egovframework/com/utl/sys/pxy/icon/no_required.gif" width="15" height="15" alt="" /></th>
        <td class="lt_text"><c:out value='${proxySvc.svcDc}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row">서비스IP<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt="" /></th>
        <td class="lt_text"><c:out value='${proxySvc.svcIp}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row">서비스Port<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt="" /></th>
        <td class="lt_text"><c:out value='${proxySvc.svcPort}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row">서비스상태<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt="" /></th>
