...
<!-- ********** 여기서 부터 본문 내용 *************** -->
	...
	<table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	   <h1><img src="/images/egovframework/com/uss/ion/rwd/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;포상승인관리 목록</h1></td>
	  <th>
	  </th>
  <td width="50%">&nbsp;</td>
  <th width="10%" align="right">
	...
	<caption>포상승인관리 검색조건</caption>
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchKeyword">포상구분</label><img src="/images/egovframework/com/uss/ion/rwd/icon/no_required.gif" width="15" height="15" alt=""></th>
	    <td width="30%"  >
	    ...
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchFromDate">포상일자</label><img src="/images/egovframework/com/uss/ion/rwd/icon/no_required.gif" width="15" height="15" alt=""></th>
	    <td width="30%" nowrap >
	  ...
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchNm">포상자</label><img src="/images/egovframework/com/uss/ion/rwd/icon/no_required.gif" width="15" height="15" alt=""></th>
	    <td width="30%" >
	    <input name="searchNm" type="text" size="20" value="${rwardManageVO.searchNm}"  maxlength="100" title="포상자" >
	    </td>
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchConfmAt">진행구분</label><img src="/images/egovframework/com/uss/ion/rwd/icon/no_required.gif" width="15" height="15" alt=""></th>
	    <td width="30%">
