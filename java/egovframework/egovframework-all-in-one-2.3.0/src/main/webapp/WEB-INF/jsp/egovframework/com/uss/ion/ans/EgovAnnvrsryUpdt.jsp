...
<caption>기념일관리 수정</caption>
  <tr> 
    <th height="23" class="required_text" scope="row">신청자<img src="/images/egovframework/com/uss/ion/ans/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td><c:out value="${annvrsryManageVO.annvrsryTemp1      }"/></td>
    <th height="23" class="required_text" scope="row">소속<img src="/images/egovframework/com/uss/ion/ans/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td><c:out value="${annvrsryManageVO.annvrsryTemp2      }"/></td>
  </tr> 
  <tr> 
    <th height="23" class="required_text" scope="row">기념일구분<img src="/images/egovframework/com/uss/ion/ans/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td>
      <form:select path="annvrsrySe" title="기념일구분">
	      <form:options items="${annvrsrySeCode}" itemValue="code" itemLabel="codeNm"/>
      </form:select></td>
    <th height="23" class="required_text" scope="row">기념일<img src="/images/egovframework/com/uss/ion/ans/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td>
  ...
  <tr> 
    <th height="23" class="required_text" scope="row"><label for="memo">메모</label><img src="/images/egovframework/com/uss/ion/ans/icon/no_required.gif" width="15" height="15" alt=""></th>
    <td colspan="3">
