...
<caption>소속정보</caption>
  <tr>
    <th width="20%" height="23" class="required_text"  >신청자<img src="/images/egovframework/com/uss/ion/ctn/icon/no_required.gif" width="15" height="15" alt=""></th>          
    <td width="30%"><c:out value='${ctsnnManageVO.usNm}'/></td>
    <th width="20%" height="23" class="required_text"  >소속<img src="/images/egovframework/com/uss/ion/ctn/icon/no_required.gif" width="15" height="15" alt=""></th>          
