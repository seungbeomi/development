...
<link href="<c:url value='/css/egovframework/com/utl/sys/srm/com.css' />" rel="stylesheet" type="text/css">
<link href="<c:url value='/css/egovframework/com/utl/sys/srm/button.css' />" rel="stylesheet" type="text/css">
...
<table width="100%" class="table-search" border="0">
 <tr>
  <td width="210"class="title_left">
   <h1><img src="<c:url value='/images/egovframework/com/utl/sys/srm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" style="vertical-align:middle;" alt="">&nbsp;서버자원모니터링  로그목록</h1>
  </td>
