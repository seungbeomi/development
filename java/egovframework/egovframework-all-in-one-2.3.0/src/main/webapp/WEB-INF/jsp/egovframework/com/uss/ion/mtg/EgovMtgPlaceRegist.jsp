...
<caption>회의실 등록</caption>
  <tr> 
    <th height="23" height="23" class="required_text" scope="row"><label for="mtgPlaceNm">회의실 명</label><img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td colspan ="3">
...
~        <select name="opnEndTm" title="개방종료시간">
  ...
  <tr>
	<th width="20%" height="23" class="required_text"  scope="row"><label for="txtComFileUploader">이미지 파일첨부</label><img src="/images/egovframework/com/uss/ion/mtg/icon/no_required.gif" width="15" height="15" alt=""></th>
	<td colspan="3" >
