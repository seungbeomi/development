...
<link href="<c:url value='/css/egovframework/com/utl/sys/nsm/com.css' />" rel="stylesheet" type="text/css">
<link href="<c:url value='/css/egovframework/com/utl/sys/nsm/button.css' />" rel="stylesheet" type="text/css">
