...
<caption>기념일관리 등록</caption>
  <tr> 
    <th height="23" class="required_text" scope="row"><label for="annvrsryTemp1">신청자</label><img src="/images/egovframework/com/uss/ion/ans/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    ...
    <th height="23" class="required_text" scope="row"><label for="annvrsryTemp2">소속</label><img src="/images/egovframework/com/uss/ion/ans/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
  ...
  <tr> 
    <th height="23" class="required_text" scope="row"><label for="annvrsrySe">기념일구분</label><img src="/images/egovframework/com/uss/ion/ans/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    ...
    <th height="23" class="required_text" scope="row"><label for="annvrsryDe">기념일</label><img src="/images/egovframework/com/uss/ion/ans/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td>
  ...
  <tr> 
    <th height="23" class="required_text" scope="row"><label for="annvrsryNm">기념일명</label><img src="/images/egovframework/com/uss/ion/ans/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td colspan="3">
  ...
  <tr> 
    <th height="40" class="required_text" scope="row"><label for="memo">메모</label><img src="/images/egovframework/com/uss/ion/ans/icon/no_required.gif" width="15" height="15" alt=""></th>
    <td colspan="3">
      <label for="memo">
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row" ><label for="annvrsryBeginDe">알림시작일</label><img src="/images/egovframework/com/uss/ion/ans/icon/no_required.gif" width="15" height="15" alt=""></th>
    <td width="20%">D-
        <label for="memo">
    ...
    <th width="20%" height="23" class="required_text" scope="row"><label for="annvrsrySetup">알림설정</label><img src="/images/egovframework/com/uss/ion/ans/icon/no_required.gif" width="15" height="15" alt=""></th>
