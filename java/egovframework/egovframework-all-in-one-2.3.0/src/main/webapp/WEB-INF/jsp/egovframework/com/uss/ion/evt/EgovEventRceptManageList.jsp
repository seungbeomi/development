...
<!-- ********** 여기서 부터 본문 내용 *************** -->
	...
	<table width="700" cellpadding="8" class="table-search" border="0" >
	 <tr>
	  <td width="40%"class="title_left">
	   <h1><img src="/images/egovframework/com/uss/ion/evt/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;행사접수관리 목록</h1></td>
	  <th> </th>
	  <td width="50%">&nbsp;</td>
	  <th width="10%">
	...
	<caption>행사접수관리 검색조건</caption>
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchSe">행사구분</label><img src="/images/egovframework/com/uss/ion/evt/icon/no_required.gif" width="15" height="15" alt=""></th>          
	    <td width="30%" >
	    ...
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchYear">행사년월</label><img src="/images/egovframework/com/uss/ion/evt/icon/no_required.gif" width="15" height="15" alt=""></th>          
	    <td width="30%">
	  ...
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchNm">행사명</label><img src="/images/egovframework/com/uss/ion/evt/icon/no_required.gif" width="15" height="15" alt=""></th>          
	    <td width="30%" >
	    	<input name="searchNm" type="text" size="20" value="${eventManageVO.searchNm}"  maxlength="100" title="행사명"> 
	    </td>
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchConfmAt">진행구분</label><img src="/images/egovframework/com/uss/ion/evt/icon/no_required.gif" width="15" height="15" alt=""></th>          
	    <td width="30%">
	...
	<tr>
		...
		<td class="lt_text3" nowrap><c:out value="${resultInfo.eventTemp2}"/>/<c:out value="${resultInfo.garden}"/></td>
