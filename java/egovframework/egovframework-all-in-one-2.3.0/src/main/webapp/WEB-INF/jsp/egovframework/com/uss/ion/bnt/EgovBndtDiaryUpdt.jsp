...
<!-- 등록  폼 영역  -->
	...
	<tr>
		<td class="lt_text3" nowrap><c:out value="${resultInfo.bndtCeckCdNm}"/><img src="/images/egovframework/com/uss/ion/bnt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></td>
