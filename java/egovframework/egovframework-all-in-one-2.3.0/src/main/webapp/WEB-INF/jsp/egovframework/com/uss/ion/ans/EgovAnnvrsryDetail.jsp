...
<!-- ********** 여기서 부터 본문 내용 *************** -->
	...
	<caption>기념일관리 상세</caption>
	  <tr> 
	    <th height="23" class="required_text" scope="row">신청자<img src="/images/egovframework/com/uss/ion/ans/icon/required.gif" alt="필수입력표시" width="15" height="15"></th>
	    <td><c:out value="${annvrsryManageVO.annvrsryTemp1      }"/></td>
	    <th height="23" class="required_text" scope="row">소속<img src="/images/egovframework/com/uss/ion/ans/icon/required.gif" alt="필수입력표시" width="15" height="15"></th>
	    <td><c:out value="${annvrsryManageVO.annvrsryTemp2      }"/></td>
	  </tr> 
	  <tr> 
	    <th height="23" class="required_text" scope="row">기념일구분<img src="/images/egovframework/com/uss/ion/ans/icon/required.gif" alt="필수입력표시" width="15" height="15"></th>
	    <td><c:out value="${annvrsryManageVO.annvrsryTemp3      }"/></td>
	    <th height="23" class="required_text" scope="row">기념일<img src="/images/egovframework/com/uss/ion/ans/icon/required.gif" alt="필수입력표시" width="15" height="15"></th>
	    <td><c:out value="${annvrsryManageVO.annvrsryTemp4      }"/>&nbsp;&nbsp;
	    <c:if test="${'1' eq annvrsryManageVO.reptitSe}"><b>매년반복</b></c:if>
	    </td>
	  </tr>
	  <tr> 
	    <th height="23" class="required_text" scope="row">기념일제목<img src="/images/egovframework/com/uss/ion/ans/icon/required.gif" alt="필수입력표시" width="15" height="15"></th>
	    <td colspan="3"><c:out value="${annvrsryManageVO.annvrsryNm      }"/> </td>
	  </tr>
	  <tr> 
	    <th height="23" class="required_text" scope="row">메모<img src="/images/egovframework/com/uss/ion/ans/icon/no_required.gif" width="15" height="15" alt=""></th>
	    <td colspan="3">
	  ...
	  <tr> 
	    <th width="20%" height="23" class="required_text" scope="row">알림시작일<img src="/images/egovframework/com/uss/ion/ans/icon/no_required.gif" alt="필수입력표시" width="15" height="15"></th>
	    <td width="20%">D-<c:out value="${annvrsryManageVO.annvrsryBeginDe      }"/>일전 알림</td>
	    <th width="20%" height="23" class="required_text" scope="row">알림설정<img src="/images/egovframework/com/uss/ion/ans/icon/no_required.gif" alt="필수입력표시" width="15" height="15"></th>
