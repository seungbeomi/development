...
<c:set var="ImgUrl" value="/images/egovframework/com/dam/spe/spe/"/>
<c:set var="CssUrl" value="/css/egovframework/com/dam/spe/spe/"/>
...
<html lang="ko">
	<head>
		 ...
		 ******************************************************** */
		function fnRegist(){
			location.href = "/dam/spe/spe/EgovComDamSpecialistRegist.do";
		}
		/* ********************************************************
		 * 수정 처리 함수
		 ******************************************************** */
		  				...
		  				<th width="20%">
		   					<table border="0" cellspacing="0" cellpadding="0">
		    					<tr> 
	      							...
	      							<td>&nbsp;</td>
								    <td><img src="<c:out value="${ImgUrl}"/>button/bu2_left.gif" alt="등록버튼" title="등록버튼" width="8" height="20"></td>
								    <td class="btnBackground" nowrap="nowrap"><a href="/dam/spe/spe/EgovComDamSpecialistRegist.do"><spring:message code="button.create" /></a></td>
								    <td><img src="<c:out value="${ImgUrl}"/>button/bu2_right.gif" alt="등록버튼" title="등록버튼" width="8" height="20"></td>      
	      							<td>&nbsp;</td>
		    					</tr>
		   					</table>
		  				</th>  
					...
					<tbody>
						<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
							<tr>					
								...
								<td class="lt_text3">
								<a href="/dam/spe/spe/EgovComDamSpecialist.do?pageIndex=${searchVO.pageIndex}&amp;speId=${resultInfo.speId}&amp;knoTypeCd=${resultInfo.knoTypeCd}&amp;appTypeCd=${resultInfo.appTypeCd}"><c:out value="${resultInfo.userNm}"/></a>								
								</td>								
