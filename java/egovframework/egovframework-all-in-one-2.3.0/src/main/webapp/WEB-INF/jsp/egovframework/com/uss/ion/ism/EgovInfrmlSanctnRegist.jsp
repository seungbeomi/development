...
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register">
  <tr>
    <th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="sanctnDtNm">승인권자명</label><img src="/images/egovframework/com/uss/ion/ism/icon/required.gif" alt="필수항목"  width="15" height="15"></th>
    ...
    <th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="orgnztNm">소속</label><img src="/images/egovframework/com/uss/ion/ism/icon/no_required.gif" width="15" height="15" alt=""></th>
    <td width="30%" nowrap colspan="3">
