	...
	<table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	   <h1><img src="/images/egovframework/com/uss/ion/ctn/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;경조사승인관리 목록</h1></td>
	  <th>
	  </th>
	  <td width="50%">&nbsp;</td>
	  <th width="10%">
...
<caption>경조승인 검색조건</caption>
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchKeyword">경조구분</label><img src="/images/egovframework/com/uss/ion/ctn/icon/no_required.gif" width="15" height="15" alt=""></th>
	    <td width="30%"  >
	    ...
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchFromDate">신청일자</label><img src="/images/egovframework/com/uss/ion/ctn/icon/no_required.gif" width="15" height="15" alt=""></th>
	    <td width="30%" >
	  ...
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchNm">신청자</label><img src="/images/egovframework/com/uss/ion/ctn/icon/no_required.gif" width="15" height="15" alt=""></th>
	    <td width="30%" >
	    <input name="searchNm" type="text" size="20" value="${ctsnnManageVO.searchNm}"  maxlength="100" title="신청자">
	    </td>
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchConfmAt">진행구분</label><img src="/images/egovframework/com/uss/ion/ctn/icon/no_required.gif" width="15" height="15" alt=""></th>
	    <td width="30%">
