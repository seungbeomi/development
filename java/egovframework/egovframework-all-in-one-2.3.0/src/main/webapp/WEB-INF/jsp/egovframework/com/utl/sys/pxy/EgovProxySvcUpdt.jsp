...
<link href="<c:url value='/css/egovframework/com/utl/sys/pxy/com.css' />" rel="stylesheet" type="text/css">
<link href="<c:url value='/css/egovframework/com/utl/sys/pxy/button.css' />" rel="stylesheet" type="text/css">
...
<table border="0">
  <tr>
    ...
    <table width="100%" cellpadding="1" class="table-register" summary="프록시설정 정보를 수정한다.">
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>프록시ID<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>프록시명<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>프록시IP<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>프록시Port<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>대상서비스명<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서비스설명<img src="/images/egovframework/com/utl/sys/pxy/icon/no_required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서비스IP<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서비스Port<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서비스상태<img src="/images/egovframework/com/utl/sys/pxy/icon/required.gif" width="15" height="15" alt=""></th>
