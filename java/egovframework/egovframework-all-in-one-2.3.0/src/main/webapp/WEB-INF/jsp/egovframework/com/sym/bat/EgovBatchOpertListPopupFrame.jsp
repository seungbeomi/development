...
<!-- iframe -->
<iframe title="배치작업목록" id="batchOpertPopupFrame" src="/sym/bat/getBatchOpertList.do?popupAt=Y" width="100%" height="575px" frameborder="0" scrolling="no" marginwidth="0" marginheight="0" >
</iframe>
</DIV>
</body>
</html>
