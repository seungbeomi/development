...
<tr>
	...
	<tr> 
		...
		<td class="btnBackground"><input type="submit" value="<spring:message code="button.inquire" />" onclick="fn_egov_search_RequestOffer(); return false;" class="btnNew" style="height:20px;width:26px;" ></td>
		...
		<td><img src="<c:out value="${ImgUrl}"/>button/bu2_left.gif"  width="8" height="20"></td>
      	<td class="btnBackground" nowrap><a href="/dam/spe/req/registRequestOffer.do?pageIndex=<c:out value='${searchVO.pageIndex}'/>"><spring:message code="button.create" /></a>
      	<td><img src="<c:out value="${ImgUrl}"/>button/bu2_right.gif" width="8" height="20" alt="버튼이미지"></td>		
	</tr>
	</table>
	</th>  
