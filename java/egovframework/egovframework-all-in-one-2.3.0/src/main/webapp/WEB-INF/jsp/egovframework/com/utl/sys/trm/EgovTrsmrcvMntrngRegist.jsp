...
<c:set var="imgUrl" value="/images/egovframework/com/utl/sys/trm/"/>
<c:set var="cssUrl" value="/css/egovframework/com/utl/sys/trm/"/>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="송수신모니터링 등록을 제공한다.">
  <tr> 
    ...
    <td width="80%" nowrap>
        ...
        <a href="#LINK" onClick="javascript:fn_egov_popup_cntc_list(); return false;" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/com/cmm/search2.gif' />"
