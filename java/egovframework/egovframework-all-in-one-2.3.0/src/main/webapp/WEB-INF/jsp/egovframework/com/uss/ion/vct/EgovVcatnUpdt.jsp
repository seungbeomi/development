...
<caption>휴가관리 수정</caption>
  ...
  <tr>
    ...
    <th width="20%" height="23" class="required_text"   scope="row"><span id="nameSpan"><label for="noonSe">정오구분</label></span><img src="/images/egovframework/com/uss/ion/vct/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%">
        <span id="noonSeSpan">
