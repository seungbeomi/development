...
<link href="<c:url value='/css/egovframework/com/utl/sys/fsm/com.css' />" rel="stylesheet" type="text/css">
<link href="<c:url value='/css/egovframework/com/utl/sys/fsm/button.css' />" rel="stylesheet" type="text/css">
