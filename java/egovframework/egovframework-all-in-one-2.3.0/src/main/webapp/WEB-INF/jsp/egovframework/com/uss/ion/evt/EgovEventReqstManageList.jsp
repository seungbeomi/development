	...
	<table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	   <h1><img src="/images/egovframework/com/uss/ion/evt/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;행사신청관리 목록</h1></td>
	  <th></th>
  <td width="50%">&nbsp;</td>
  <th width="10%" align="right">
	...
	<tr>
        ...
        <form name="item" method="post" action="<c:url value='/uss/ion/evt/EgovEventReqstAtdrnList.do'/>"  target="_blank">
        	<input type=hidden name="eventId" value="<c:out value="${resultInfo.eventId      }"/>">
            <span class="link"><input type="submit" value="<c:out value="${resultInfo.eventTemp2}"/>" onclick="fncEventReqstAtdrnList('<c:out value="${resultInfo.eventId}"/>'); return false;" style="text-align : left;"></span>/<c:out value="${resultInfo.garden}"/>
        </form></td>
