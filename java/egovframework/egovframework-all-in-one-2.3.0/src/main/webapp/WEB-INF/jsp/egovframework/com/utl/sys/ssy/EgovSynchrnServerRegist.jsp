...
<table border="0">
  <tr>
    ...
    <table width="100%" cellpadding="1" class="table-register" summary="동기화대상 서버정보를 등록한다.">
      ...
      <!--  
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서버ID<img src="/images/egovframework/com/utl/sys/ssy/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      -->
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서버명<img src="/images/egovframework/com/utl/sys/ssy/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서버 IP<img src="/images/egovframework/com/utl/sys/ssy/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서버 Port<img src="/images/egovframework/com/utl/sys/ssy/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>FTP ID<img src="/images/egovframework/com/utl/sys/ssy/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>FTP 비밀번호<img src="/images/egovframework/com/utl/sys/ssy/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>동기화 위치<img src="/images/egovframework/com/utl/sys/ssy/icon/required.gif" width="15" height="15" alt=""></th>
