...
<c:set var="ImgUrl" value="/images/egovframework/com/uss/ion/evt/"/>
...
<caption>행사관리 등록</caption>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventSe">행사구분</label><img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
  ...
  <tr> 
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventNm">행사명</label><img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventPurps">행사목적</label><img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventBeginDe">행사기간</label><img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventAuspcInsttNm">행사주최</label><img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventMngtInsttNm">행사주관</label><img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventPlace">행사장소</label><img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="refrnUrl">참조URL</label><img src="/images/egovframework/com/uss/ion/evt/icon/no_required.gif" width="15" height="15" alt=""></th>          
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventCn">행사내용</label><img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="ctOccrrncAt">참가비용</label><img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="garden">정원</label><img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="rceptBeginDe">행사접수기간</label><img src="/images/egovframework/com/uss/ion/evt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%" >
