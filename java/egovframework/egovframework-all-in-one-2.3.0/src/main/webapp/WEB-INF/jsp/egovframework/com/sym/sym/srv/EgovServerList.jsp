...
<table width="100%" cellpadding="8" class="table-list" summary="서버정보에 대한 목록을 제공한다.">
 ...
 <c:forEach var="server" items="${serverList}" varStatus="status">
  <tr>
    ...
    <!-- <td class="lt_text3" nowrap><a href="<c:url value='/images/egovframework/com/cmm/search2.gif'/>" width="15" height="15" alt=""></a></td>-->
    <td class="lt_text3" nowrap><a href="#" onClick="windowOpen('<c:out value="${server.serverId}"/>')"><img src="<c:url value='/images/egovframework/com/cmm/search2.gif'/>" width="15" height="15" alt=""></a></td>
  </tr>
 </c:forEach>
 </tbody>
</table>
