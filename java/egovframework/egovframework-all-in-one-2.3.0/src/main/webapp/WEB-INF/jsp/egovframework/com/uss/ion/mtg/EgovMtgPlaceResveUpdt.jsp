...
<caption>회의실예약관리수정</caption>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="mtgSj">제목</label><img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td colspan ="3">
       <input name="mtgSj" type="text" size="50" value="<c:out value='${mtgPlaceManageVO.mtgSj}'/>" maxlength="70" style="width:90%;" title="제목">
    </td>
  </tr>
  <tr>
    <th height="23" class="required_text" scope="row">회의실명<img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td colspan ="3"><c:out value='${mtgPlaceManageVO.mtgPlaceNm}'/></td>
  </tr>
  <tr>
    <th height="23" class="required_text" scope="row">회의실 위치<img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">예약자<img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td width="30%"><c:out value='${mtgPlaceManageVO.mtgPlaceTemp4}'/></td>
    <th width="20%" height="23" class="required_text" scope="row">소속<img src="/images/egovframework/com/uss/ion/mtg/icon/no_required.gif" width="15" height="15" alt=""></th>
    <td width="30%"><c:out value='${mtgPlaceManageVO.mtgPlaceTemp5}'/></td>
  </tr>
  <tr>
    <th height="23" class="required_text"  scope="row"><label for="resveDe">예약시간</label><img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td colspan ="3">
...
~        <select name="resveEndTm" title="예약종료시간">
  ...
  <tr>
    <th height="23" class="required_text"  scope="row"><label for="atndncNmpr">참석인원</label><img src="/images/egovframework/com/uss/ion/mtg/icon/no_required.gif" width="15" height="15" alt=""></th>
    <td colspan ="3">
  ...
  <tr>
    <th height="23" class="required_text"  scope="row"><label for="mtgCn">회의내용</label><img src="/images/egovframework/com/uss/ion/mtg/icon/no_required.gif" width="15" height="15" alt=""></th>
    <td colspan ="3">
