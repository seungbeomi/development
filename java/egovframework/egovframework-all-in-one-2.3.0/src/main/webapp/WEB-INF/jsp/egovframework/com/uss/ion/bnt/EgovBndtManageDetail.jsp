...
<caption>당직 상세</caption>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">당직자명<img src="/images/egovframework/com/uss/ion/bnt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%" ><c:out value='${bndtManageVO.bndtTemp1}'/></td>
  </tr> 
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row">소속<img src="/images/egovframework/com/uss/ion/bnt/icon/no_required.gif" width="15" height="15" alt=""></th>
    <td width="80%" ><c:out value='${bndtManageVO.bndtTemp2}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">당직일자<img src="/images/egovframework/com/uss/ion/bnt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%" ><c:out value='${bndtManageVO.bndtDe}'/></td>    
  </tr> 
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row">비고<img src="/images/egovframework/com/uss/ion/bnt/icon/no_required.gif" width="15" height="15" alt=""></th>
    <td width="30%" class="title_left">
