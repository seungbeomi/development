...
<table border="0">
  <tr>
	...
	<table width="100%" cellpadding="1" class="table-register" summary="장애신청에 대한 상세정보를 제공한다.">
	  ...
	  <tr>
	    <th class="required_text" width="20%" height="80" scope="row">장애설명<img src="/images/egovframework/com/sym/tbm/tbr/icon/required.gif" width="15" height="15" alt=""></th>
	  ...
	  <tr>
	    <th class="required_text" width="20%" scope="row" nowrap>장애요청시간<img src="/images/egovframework/com/sym/tbm/tbr/icon/required.gif" width="15" height="15" alt=""></th>
	    <td class="lt_text" nowrap><c:out value='${troblReqst.troblRequstTime}'/></td>
	  </tr>    
	  <tr>
	    <th class="required_text" width="20%" scope="row" nowrap>처리상태<img src="/images/egovframework/com/sym/tbm/tbr/icon/required.gif" width="15" height="15" alt=""></th>
    ...
    <table width="100%" cellpadding="1" class="table-register">
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>처리결과<img src="/images/egovframework/com/sym/tbm/tbr/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>처리시간<img src="/images/egovframework/com/sym/tbm/tbr/icon/required.gif" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><c:out value='${troblReqst.troblProcessTime}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>처리자<img src="/images/egovframework/com/sym/tbm/tbr/icon/required.gif" width="15" height="15" alt=""></th>
