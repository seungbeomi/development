...
<link href="<c:url value='/css/egovframework/com/utl/sys/rsc/com.css' />" rel="stylesheet" type="text/css">
<link href="<c:url value='/css/egovframework/com/utl/sys/rsc/button.css' />" rel="stylesheet" type="text/css">
...
<table border="0">
  <tr>
    ...
    <table width="100%" class="table-search" border="0">
     <tr>
      <td width="170" class="title_left"><h1><img src="<c:url value='/images/egovframework/com/utl/sys/rsc/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" style="vertical-align:middle;" alt="">&nbsp;로그인 세션정보 체크</h1></td>
      <td width="400">&nbsp;</td>
    ...
    <table width="100%" cellpadding="8" class="table-line" summary="로그인 세션정보를 설정 및 체크한다.">
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>URL<img src="/images/egovframework/com/utl/sys/rsc/icon/required.gif" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><label for="url"><input name="url" id="url" type="text" maxLength="1000" size="80" ></label></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>세션 URL<img src="/images/egovframework/com/utl/sys/rsc/icon/required.gif" width="15" height="15" alt=""></th>
