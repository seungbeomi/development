...
<caption>회의실 상세</caption>
  <tr> 
    <th height="23" class="required_text" scope="row">회의실 명<img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td colspan ="3"><c:out value='${mtgPlaceManage.mtgPlaceNm}'/></td>
  </tr> 
  <tr> 
    <th width="20%" height="23" class="required_text"  scope="row">수용가능인원<img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td width="20%" ><c:out value='${mtgPlaceManage.aceptncPosblNmpr}'/>명 </td>
    <th width="20%" height="23" class="required_text"  scope="row">개방시간<img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td ><c:out value='${mtgPlaceManage.opnBeginTm}'/> ~ <c:out value='${mtgPlaceManage.opnEndTm}'/></td>
  </tr>
  <tr> 
    <th width="20%" height="23" class="required_text"  scope="row">위치<img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
...
<!--  첨부파일 테이블 레이아웃 설정 Start.. -->
  <c:if test="${!empty mtgPlaceManage.atchFileId}">
	<tr> 
		<th height="23" class="required_text" scope="row">이미지 파일목록<img src="/images/egovframework/com/uss/ion/mtg/icon/no_required.gif" width="15" height="15" alt=""></th>
		    <td colspan="3">
...
<caption>회의실  비품정보 상세</caption>
  <tr> 
    <th width="20%" height="100" class="required_text"  scope="row">비품정보<img src="/images/egovframework/com/uss/ion/mtg/icon/no_required.gif" width="15" height="15" alt=""></th>
