...
<!-- ********** 여기서 부터 본문 내용 *************** -->
	...
	<table width="670" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	      <h1><img src="/images/egovframework/com/uss/ion/ans/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;기념일일괄등록</h1></td>
	  <th>
	  </th>
	  <td width="10%"></td>
	  <td width="35%"></td>
	...
	<table width="670" border="0" cellpadding="0" cellspacing="1" class="table-register">
	  <tr>
	    <th width="20%" height="23" class="required_text"  > 기념일 엑셀파일<img src="/images/egovframework/com/uss/ion/ans/icon/no_required.gif" width="15" height="15" alt=""></th>          
