...
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register"  summary="포상자정보" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"   scope="row">포상자<img src="/images/egovframework/com/uss/ion/rwd/icon/no_required.gif" width="15" height="15" alt=""></th>          
    <td width="30%"><c:out value='${rwardManageVO.rwardManNm}'/></td>
    <th width="20%" height="23" class="required_text"   scope="row">소속<img src="/images/egovframework/com/uss/ion/rwd/icon/no_required.gif" width="15" height="15" alt=""></th>          
...
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register"  summary="포상승인" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"   scope="row">포상구분<img src="/images/egovframework/com/uss/ion/rwd/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3"  ><c:out value='${rwardManageVO.rwardCdNm}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text"   scope="row">포상명<img src="/images/egovframework/com/uss/ion/rwd/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"  ><c:out value='${rwardManageVO.rwardNm}'/></td>
    <th width="20%" height="23" class="required_text"   scope="row">포상일<img src="/images/egovframework/com/uss/ion/rwd/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"  ><c:out value='${rwardManageVO.rwardDe}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text"   scope="row">공적사항<img src="/images/egovframework/com/uss/ion/rwd/icon/no_required.gif" width="15" height="15" alt=""></th>          
    <td colspan="3"  >
...
<!-- 첨부파일 테이블 레이아웃 설정 Start..-->
  <c:if test="${result.atchFileId != ''}">
	<tr> 
		<th height="23" class="required_text"  scope="row">첨부파일목록<img src="/images/egovframework/com/uss/ion/rwd/icon/no_required.gif" width="15" height="15" alt=""></th>
		    <td colspan="3">
