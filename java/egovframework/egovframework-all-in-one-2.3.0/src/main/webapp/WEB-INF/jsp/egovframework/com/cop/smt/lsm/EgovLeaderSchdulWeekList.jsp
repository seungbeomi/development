...
<td height="60">
    ...
    <td>
		...
		<td>
			...
			<img src="<c:url value='/images/egovframework/com/cop/smt/lsm/icon/icoPrev.gif' />" style="margin-right:4px;border:0px;" alt="이전주">
			</a>
			<%}%>
			<font size='3'><b><%=iNowWeek+1%>주</b></font>
			<%if(iNowWeek < listWeekGrop.size()-1 ){ %>
			<a href="<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulWeekList.do' />?year=<%=iNowYear%>&amp;month=<%=iNowMonth%>&amp;week=<%=iNowWeek+1%>" target="_self">
			<img src="<c:url value='/images/egovframework/com/cop/smt/lsm/icon/icoNxt.gif' />" style="margin-left:4px;border:0px;" alt="다음주">
			</a> 
			<%}%>
			</td>			
			</tr>
