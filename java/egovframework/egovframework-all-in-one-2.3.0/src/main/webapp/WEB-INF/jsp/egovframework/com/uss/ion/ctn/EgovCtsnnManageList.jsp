...
<!-- ********** 여기서 부터 본문 내용 *************** -->
	...
	<table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	   <h1><img src="/images/egovframework/com/uss/ion/ctn/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;경조사 관리 목록</h1></td>
	  <th>
	  </th>
	  <td width="50%">&nbsp;</td>
	  <th width="10%">
	...
	<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="경조목록 검색조건" >
	  ...
	  <tr>
	    ...
	    <th width="20%" height="23" class="required_text"  scope="row"><label for="searchFromDate">발생일자</label><img src="/images/egovframework/com/uss/ion/ctn/icon/no_required.gif" width="15" height="15" alt=""></th>
	    <td width="30%">
