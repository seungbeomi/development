...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register"  summary="회의실예약 상세" >
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row">제목<img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
  ...
  <tr> 
    <th height="23" class="required_text" scope="row">예약시간<img src="/images/egovframework/com/uss/ion/mtg/icon/required.gif" width="15" height="15" alt="필수입력표시"></th>
  ...
  <tr> 
    <th height="23" class="required_text" scope="row">참석인원<img src="/images/egovframework/com/uss/ion/mtg/icon/no_required.gif" width="15" height="15" alt=""></th>
    <td colspan ="3"><c:out value='${mtgPlaceManageVO.atndncNmpr}'/>명</td>
  </tr>
  <tr> 
    <th height="23" class="required_text" scope="row">회의내용<img src="/images/egovframework/com/uss/ion/mtg/icon/no_required.gif" width="15" height="15" alt=""></th>
    <td colspan ="3">
