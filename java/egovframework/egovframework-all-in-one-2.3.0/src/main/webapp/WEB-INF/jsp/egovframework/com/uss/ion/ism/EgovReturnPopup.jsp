   ...
   <table width="700" cellpadding="0" class="table-search" border="0">
	 <tr>
	  <td width="40%" height="17" class="title_left">
	   <h1><img src="/images/egovframework/com/uss/ion/ism/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;반려</h1>
	  </td>
...
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register">
  <tr>
    <th scope="row" width="20%" height="23" class="required_text"><label for="returnResn">반려사유</label><img src="/images/egovframework/com/uss/ion/ism/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%">
