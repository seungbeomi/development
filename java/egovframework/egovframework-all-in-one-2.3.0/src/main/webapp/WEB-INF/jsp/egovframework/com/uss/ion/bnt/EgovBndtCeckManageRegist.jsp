...
<caption>당직체크 등록</caption>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="bndtCeckSe">당직체크구분</label><img src="/images/egovframework/com/uss/ion/bnt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="bndtCeckCd">당직체크코드</label><img src="/images/egovframework/com/uss/ion/bnt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="bndtCeckCdNm">당직체크코드명</label><img src="/images/egovframework/com/uss/ion/bnt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="80%">
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="useAt">사용여부</label><img src="/images/egovframework/com/uss/ion/bnt/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
