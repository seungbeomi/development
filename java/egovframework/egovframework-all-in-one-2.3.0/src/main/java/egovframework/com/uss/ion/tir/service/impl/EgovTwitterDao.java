...
public class EgovTwitterDao extends EgovComAbstractDAO {
    ...
    public Map selectTwitterAccount(Map param) throws Exception {
    	return (Map)getSqlMapClientTemplate().queryForObject("Twitter.selectTwitterAccount",param);
    }
    ...
    public int selectTwitterAccountCheck(Map param) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("Twitter.selectTwitterAccountCheck",param);
    }
