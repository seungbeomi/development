...
//            }
            ...
            try { if (finput != null) finput.close(); }
            	catch (Exception e2) { //e2.printStackTrace();
        		log.error("IGNORE:", e2);}	// 2011.10.10 보안점검 후속조치
            try { if (aosOutput != null) aosOutput.close(); }
            	catch (Exception e2) { //e2.printStackTrace();
        		log.error("IGNORE:", e2);}	// 2011.10.10 보안점검 후속조치
            try { if (fosOutput != null) fosOutput.close(); }
            	catch (Exception e2) { //e2.printStackTrace();
        		log.error("IGNORE:", e2);}	// 2011.10.10 보안점검 후속조치
            try { if (result == false) targetFile.delete(); }
            	catch (Exception e2) { //e2.printStackTrace();
        		log.error("IGNORE:", e2);}	// 2011.10.10 보안점검 후속조치
        }
