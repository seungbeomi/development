...
public class ComCodeServiceTest extends TestSupport {
  ...
  @Test
  public void testSelectComCodeCnt() {
    ComCode comCode = new ComCode();
    int cnt = comCodeService.selectComCodeCnt(comCode);
    assertEquals(75, cnt);
    
    comCode.setSearchCondition("1");
    comCode.setSearchKeyword("COM001");
    cnt = comCodeService.selectComCodeCnt(comCode);
    assertEquals(1, cnt);
  ...
  public void testCUDComCode() {
    ...
    comCode.setClCode("BSI");
    comCode.setUseAt('Y');
    comCode.setCreatedbyId("createdbyId");
    ...
    comCode.setLastmodifiedbyId("update");
