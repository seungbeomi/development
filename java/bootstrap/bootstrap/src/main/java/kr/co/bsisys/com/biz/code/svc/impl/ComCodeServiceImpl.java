 ...
 */
package kr.co.bsisys.com.biz.code.svc.impl;
...
import kr.co.bsisys.com.biz.code.svc.ComCodeService;
...
public class ComCodeServiceImpl implements ComCodeService {
  ...
  @Override
  public int selectComCodeCnt(ComCode comCode) {
    return comCodeDao.selectComCodeCnt(comCode);
  }
